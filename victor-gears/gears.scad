...
gear(
    circular_pitch = 480,
    hub_diameter=  diametro_int ,
    number_of_teeth = dientes_int,
	gear_thickness = height_int,
	rim_thickness = height_int,
	hub_thickness = height_int,
	circles=0
);
gear (
	number_of_teeth=15,
...
gear(
    diametral_pitch = (dientes_int + 2) / diametro_int,
    number_of_teeth = dientes_int,
	gear_thickness = height_int ,
	rim_thickness = height_int,
	hub_thickness = height_int,
    hub_diameter = diametro_int ,
    bore_diameter = diametro_rosca,
	circles=0 
);

gear (
    diametral_pitch = (dientes_ext + 2) / diametro_ext,
    number_of_teeth = dientes_ext,
	gear_thickness = height_ext ,
	rim_thickness = height_ext,
	hub_thickness = height_ext  ,
    hub_diameter = diametro_ext ,
    bore_diameter = diametro_rosca,
	circles=0
);
